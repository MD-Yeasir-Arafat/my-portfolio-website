                ...
                <div class="row gx-0 align-items-center">
                    <div class="col-lg-6 col-md-10">
                        <div class="portfolio__inner__thumb">
                            <a href="{{ route('portfolio.detailes',$item->id) }}">
                    ...
                    <div class="col-lg-6 col-md-10">
                        <div class="portfolio__inner__content">
                            <h2 class="title text-capitalize"><a href="{{ route('portfolio.detailes',$item->id) }}">{{ $item->portfolio_title }}</a></h2>
                            <p>{!! Str::limit($item->portfolio_description, 250) !!}</p>
                            <a href="{{ route('portfolio.detailes',$item->id) }}" class="link">View Case Study</a>
                        </div>
                    </div>
                </div>
            </div>
