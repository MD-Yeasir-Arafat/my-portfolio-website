                  ...
                  @foreach($categoryBlog as $item)
                    <div class="standard__blog__post">
                        <div class="standard__blog__thumb">
                            <a href="{{ route('details.blog', $item->id) }}"><img src="{{ asset($item->blog_image) }}" alt=""></a>
                            <a href="{{ route('details.blog', $item->id) }}" class="blog__link"><i class="far fa-long-arrow-right"></i></a>
                        </div>
                        <div class="standard__blog__content">
                            <div class="blog__post__avatar">
                                <div class="thumb"><img src="{{ asset('upload/admin_images/'.Auth::User()->profile_image) }}" alt=""></div>
                                <span class="post__by">By : <a href="#">{{ Auth::User()->name }}</a></span>
                            </div>
                            <h2 class="title"><a href="{{ route('details.blog', $item->id) }}">{{ $item->blog_title }}</a></h2>
                            <p>
                            ...
                            <ul class="rc__post">
                                ...
                                <li class="rc__post__item">
                                    ...
                                    <div class="rc__post__content">
                                        <h5 class="title"><a href="{{ route('details.blog', $item->id) }}">{{ $item->blog_title }}</a></h5>
